@Program @all @program_page
Feature: Program Module
 As an Admin, I want to navigate to Program Page and want to see certain texts, buttons, searchbox, checkboxes table header/columns/body and pagination features
   ...
   ##################### Manage Program Validation ################################
    ...
    ###################### Seach box feature and functionality validation ***********************
	  ...
	  @ProgSearchFunctionality_ProgName  @testnow
	  Scenario: Verify Search bar on the Program page
